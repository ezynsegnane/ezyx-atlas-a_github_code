...
def main() -> None:
    ...
    # The manuscript shows mean ± SD validation AUC across all 10 seeds   #
    # for each variant.  Use the dedicated script instead:                 #
    #                                                                      #
    ...
    # single-seed two-panel figure (seed 2029, demo+anthro only) and is   #
    # retained for reference only; it must NOT be called from main() to   #
    # avoid overwriting the current Fig. 2.                                #
    # ------------------------------------------------------------------ #
    outputs.extend(
